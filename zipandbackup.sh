...
function help() {
  ...
  echo "remote_dir and local_dir must be directories, not files. backup_filename can be written with or without the .zip extension."
  echo ""
  echo "Flags"
  echo "-s, --cheatSheet  : print known pathes defined in the cheatSheet() function of the script"
  ...
  echo "./zipandbackup.sh --cheatSheet"
  echo ""
  echo "Requirements"
